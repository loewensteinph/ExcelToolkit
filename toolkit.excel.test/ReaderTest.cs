...
namespace toolkit.excel.test
{
    ...
    public class TestReader
    {
        ...
        {
            _reader = new ExcelReader("X.xlsx", "Sheet1", "A1:A5", false);
        ...
        {
            _reader = new ExcelReader("TestWB.xlsx", "Sheet1", "A1:A-1", false);
            _result = _reader.Read();
            Assert.AreEqual(null, _result);
        }
        [TestMethod]
        ...
        {
            _reader = new ExcelReader("TestWB.xlsx", "", "A1:A5", false);
            _result = _reader.Read();
            Assert.AreEqual(null, _result);
        }
        [TestMethod]
        ...
        {
            _reader = new ExcelReader("TestWB.xlsx", "Sheet1", "A2:A5", true);
            _result = _reader.Read();
        ...
        {
            _reader = new ExcelReader("TestWB.xlsx", "Sheet1", "A2:A2", false);
            _result = _reader.Read();
        ...
        {
            _reader = new ExcelReader("TestWBBig.xlsx", "Sheet1", "A1:L5500", true);
            _result = _reader.Read();
        ...
        {
            _reader = new ExcelReader("TestWBBig.xlsx", "Sheet1", "A1:L40000", true);
            _result = _reader.Read();
